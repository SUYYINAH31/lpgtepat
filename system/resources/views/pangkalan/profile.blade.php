		...
		<section id="profile-page-sec">
			<div class="profile-top-sec">
				<div class="profile-top-sec-full">
					<h1 class="d-none">Profil</h1>					
					<div class="profile-details-sec">
						<h3 class="pro-txt1">{{Auth::user()->Pangkalan->nama_pangkalan}}</h3>
						<a href="mailto:alishaparker@mail.com"><h4 class="pro-txt2">{{Auth::user()->email}}</h4></a>
						<a href="tel:+012345678899"><h5 class="pro-txt3">{{Auth::user()->Pangkalan->no_handphone}}</h5></a>
                        <a href="tel:+012345678899"><h5 class="pro-txt3">{{Auth::user()->Pangkalan->no_registrasi}}</h5></a>
				...
				<div class="container">
					<div class="profile-third-sec-full mt-24">
						...
						<div class="profile-address-sec mt-16">
							<h5 class="prile3-txt3">{{Auth::user()->Pangkalan->alamat}}</h5>
						</div>
					...
					<div class="dropdown mt-3">
						...
						<div class="app-setting-page-full mt-24">
							<div class="app-setting-top">
								...
								<a href="change-language.html.html" >
									<div class="app-setting-menu-start mt-16">
										<div class="menu-icon">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <ul class="sc-bottom-bar furniture-bottom-nav" id="furniture_navbar">
                                    <li class="nav-menu-icon active">
                                        <a href="{{ url('/') }}" class="home-icon navigation-icons">
                                            <img src="{{url('beranda.png')}}" alt="" width="70" height="20">
                                        </a>
                                    </li>
                                    <li class="nav-menu-icon">
                                        <a href="{{ url('laporan') }}" class="event-icon navigation-icons">
                                            <img src="{{url('laporan.png')}}" alt="" width="70" height="20">
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-menu-icon nav-notifi-icon">
                                        <a href="{{ url('profile') }}" class="account-icon navigation-icons right-icon active">
